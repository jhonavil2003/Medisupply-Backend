...
class Visit(db.Model):
    ...
    customer_id = db.Column(db.Integer, nullable=False)  # FK externa a sales-service
    ...
    status = db.Column(db.Enum(VisitStatus), nullable=False, default=VisitStatus.SCHEDULED)
